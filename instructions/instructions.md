...
============
  ...
  ------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ![](04.jpg)   When the applet loads, a menubar and blank x- and y-axes are displayed. The menubar is shown at left. The applet requires at least Java JRE 1.4 (aka Java 4) to run; if it does not load, this is a likely source of the problem. The JRE 1.4 plugin is available for most platforms, including Windows, Linux, and Mac.\
                \
