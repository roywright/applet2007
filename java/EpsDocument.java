...
public class EpsDocument {
    ...
    public EpsDocument(String title, int _minX, int _minY, int _maxX, int _maxY) {
        _title = title;
        minX = _minX;
        minY = _minY;
        maxX = _maxX;
    ...
    public synchronized void write(Writer writer) throws IOException {
        ...
        writer.write("%%Select all of this text (CTRL-A), copy it (CTRL-C), paste it into a text editor,\n");
        writer.write("%%and save the file with the extension .eps in order to view and use the plot.\n");
